      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white shadow-xl rounded-xl overflow-hidden">
          <div className="px-6 py-8">
            <h2 className="text-2xl font-semibold text-center text-gray-800 mb-2">Administrator Login</h2>
            <p className="text-center text-gray-500 mb-6">Access your proctoring dashboard</p>
